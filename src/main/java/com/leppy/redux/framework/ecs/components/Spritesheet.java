...
public class Spritesheet {
    ...
    public Spritesheet(Texture texture, int spriteWidth, int spriteHeight, int numSprites, int spacingX, int spacingY, int leftOffsetX, int topOffsetY, int rightOffsetX, int bottomOffsetY) {
        ...
        for (int i=0; i < numSprites; i++) {
            ...
            System.out.println(texCoords[0].x + ", " + texCoords[0].y);
            System.out.println(texCoords[1].x + ", " + texCoords[1].y);
            System.out.println(texCoords[2].x + ", " + texCoords[2].y);
            System.out.println(texCoords[3].x + ", " + texCoords[3].y);
            Sprite sprite = new Sprite(this.texture, texCoords);
            this.sprites.add(sprite);
