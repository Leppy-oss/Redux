...
public class Shader {
    ...
    /**
     * @param name corresponds to the name in the shader glsl
     * @param mat mat4f
     */
    public void uploadMat4f(String name, Matrix4f mat) {
        int location = glGetUniformLocation(shaderProgramID, name);
        FloatBuffer matBuffer = BufferUtils.createFloatBuffer(16); // 4 x 4 = 16
        mat.get(matBuffer); // upload matrix to gl buffer
