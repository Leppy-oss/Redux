...
import com.leppy.redux.ecs.Prefabs;
...
public class Gizmo extends Component {
    ...
    public void update(float dt) {
        ...
        if ((xAxisHot || xAxisActive) && Input.isDragging() && Input.mouseButtonDown(GLFW_MOUSE_BUTTON_LEFT)) {
            xAxisActive = true;
            yAxisActive = false;
        } else if ((yAxisHot || yAxisActive) && Input.isDragging() && Input.mouseButtonDown(GLFW_MOUSE_BUTTON_LEFT)) {
            yAxisActive = true;
            xAxisActive = false;
        } else {
            xAxisActive = false;
